...
export async function getAllServices(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ mensagem: "Erro ao buscar serviços", error: err });
  }
}
...
export async function getServiceById(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ mensagem: "Erro ao buscar serviço", error: err });
  }
}
...
export async function createService(req, res) {
  try {
    const { name, description, duration, price, professionalId, urlImage } =
      req.body;
    ...
    if ( !name || !description || !duration || !price || !professionalId || !urlImage ) {
      return res
        ...
        .json({
          mensagem:
            "Todos os campos são obrigatórios, inclusive a URL da imagem!",
        });
    }
    ...
    return res
      .status(500)
      .json({ mensagem: "Erro ao criar serviço", error: err.message });
  }
}
...
export async function updateService(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ mensagem: "Erro ao atualizar serviço", error: err });
  }
}
...
export async function deleteService(req, res) {
  try {
    ...
    return res
      .status(500)
      .json({ mensagem: "Erro ao deletar serviço", error: err });
  }
